...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the
			...
			// or a kick
			String ask = JOptionPane.showInputDialog(null, "Do you want to attack the dragon with a yell or a kick");
			...
			dragonsattack = rgen.nextInt(10); 
			// -- Subtract that number from the dragon's health variable
			dragonHealth = dragonHealth - dragonsattack ;
			}else 
			// 10. If they typed in "kick":
			if (ask.equalsIgnoreCase("kick")) {
			// -- Find a random number between 0 and 25 and store it in dragonDamage
			Random rnum = new Random ();
			dragonsattack = rnum.nextInt (25); 
			// -- Subtract that number from the dragon's health variable
			dragonHealth = dragonHealth - dragonsattack ; }
			// 11. Find a random number between 0 and 35 and store it in playerDamage
			Random num = new Random (); 
			playersattack = num.nextInt (35);  
			// 12. Subtract this number from the player's health
			playerHealth = playerHealth - playersattack ;
			...
			// 15. Else 
			JOptionPane.showMessageDialog(null, "Your health" + playerHealth + "and the dragon's current health" + dragonHealth ); 
